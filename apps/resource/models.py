...
class Resource(BaseModel):
    ...
    file = models.FileField(storage=MinioBackend(bucket_name='eaa'), upload_to=iso_date_prefix, blank=True, null=True, db_comment='文件数据')
    size = models.BigIntegerField(blank=True, null=True, db_comment='文件大小（Bytes）')
